    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center gap-2 p-4">
                ...
                <div className="flex flex-col gap-4 w-11/12 max-w-md">
                    ...
                    <div className="flex items-center gap-4 p-4 w-full h-28 border border-gray-300 rounded-lg">
                        ...
                        <div>
                            <h1 className="text-emerald-700 text-lg font-semibold">ถ่ายให้เห็นกระดาษครบทั้งแผ่น</h1>
                    ...
                    <a href="/camera" className="bg-emerald-700 text-white px-4 py-2 rounded-md text-center">เริ่มถ่ายภาพ</a>
